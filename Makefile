...
## Make chunks
data/interim/all_transactions_0.pkl: data/raw/new_merchant_transactions.csv data/raw/historical_transactions.csv
	$(PYTHON_INTERPRETER) src/data/make_chunks.py
